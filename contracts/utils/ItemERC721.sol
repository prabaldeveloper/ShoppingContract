    ...
    IERC721MetadataUpgradeable
{
    ...
    function updateTotalSupplyInternal(uint256 _newTotalSupply) internal {
     ...
     * Emits a {Transfer} event.
     */
    function _safeMint(address to, string memory _tokenIPFSPath) internal virtual {
        _safeMint(to, _tokenIPFSPath, "");
    }
    ...
    function _safeMint(
        ...
        uint256 tokenId = _mint(to, _tokenIPFSPath);
        require(
    ...
    function checkSupply(uint256 tokenId) internal view {
        if (_totalSupply != 0) {
            require(tokenId <= _totalSupply, "NFT721Mint : SUPPLY_LIMIT_REACHED");
        }
    }
     ...
     * Emits a {Transfer} event.
     */
    function _mint(address to, string memory _tokenIPFSPath) internal virtual returns(uint256) {
        ...
        _balances[to] += 1;
        _owners[tokenId] = to;
        _setTokenIPFSPath(tokenId, _tokenIPFSPath, to);
     ...
     */
    function _setTokenIPFSPath(uint256 tokenId, string memory _tokenIPFSPath, address _owner)
        internal
    {
        ...
        require(
            !creatorToIPFSHashToMinted[_owner][_tokenIPFSPath],
            "EventMetadata: NFT was already minted"
        );

        creatorToIPFSHashToMinted[_owner][_tokenIPFSPath] = true;
